...
const universes = [
    ...
    {id: "minecraft", name: "Minecraft", image: "/minecraft.webp", description: "Исследуйте бесконечные миры, и стройте что угодно: от простейших домов до грандиозных замков и дворцов. Играйте в творческом режиме с неограническими ресурсами или вгрызайтесь в недра мира в режиме выживания, изготавливая оружие и доспехи для защиты от опасных мобов."},
